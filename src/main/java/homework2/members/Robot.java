...
public class Robot implements Jumpable, Runnable {
    ...
    /**
     * height - на какую высоту может прыгнуть робот (в сантиметрах)
     */
    private final int height;

    /**
     * weight - сколько может пробежать робот(в метрах)
     */
    ...
    @Override
    public int jump() {
        System.out.println("Я робот, меня зовут  - '" + this.name + "' , я прыгаю");
        return this.height;
    }

    @Override
    public int run() {
        System.out.println("Я робот, меня зовут  - '" + this.name + "' , я бегу");
        return this.weight;
    }
